...
1. Переключитесь на виртуальный терминал, затем зайдите и выйдите из системы.
1. Выполните в оболочке не менее пяти команд.
1. Начните новую сессию в виртуальном терминале, переключитесь в среду рабочего стола и посмотрите активных пользователей в системе.
   Затем завершите сессию в виртуальном терминале и снова посмотрите на список пользователей.
   Что изменилось?
1. Выполните команду `bash` два раза подряд.
   Смогли ли вы выбрать на втором запуске эту команду из истории?
   Попробуйте закрыть сессию.
   Чем можете объяснить что ни первая ни вторая команда `exit` не завершили сессию?
1. Создайте два терминала, каждый из которых размещается в своей вкладке.
